// ======================================================
// Dain_Coin — entityToolbar.js v2
// Stage-agnostic Entity Editor toolbar module
// ======================================================
//
// CHANGELOG v2:
// • Убрана зависимость от __entityStage3DModule
// • Toolbar теперь зависит только от __entityEditorLogicModule
// • Работает и с entityStage3D, и с testShooterCamera
// • Сохранён EventBus-контракт entityEditor:setTool
// • Delete / Save остаются через EntityEditorLogic
// ======================================================
...
function applyParams(state) {
  ...
  state.root.style.background =
    `rgba(0,0,0,${Number(state.params.panelOpacity) || 0.42})`;
...
// CHANGELOG v2:
// • Убрана жёсткая зависимость от __entityStage3DModule.
// • Toolbar стал stage-agnostic.
// • Работает с любым модулем сцены, который слушает entityEditor:setTool.
// • Delete / Save работают через entityEditorLogic.
// • Добавлен source в payload entityEditor:setTool.