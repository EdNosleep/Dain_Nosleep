// ======================================================
// Dain_Coin — testShooterCamera.js v1
// FPS shooter test camera + PUBG-like mobile joystick
// ======================================================
//
// CHANGELOG v1:
// • Добавлен отдельный replacement-модуль вместо entityStage3D для теста
// • Сохранён renderDraft entity-сцены через текущие geometry/material helpers
// • Добавлена FPS-камера: обзор свайпом по экрану
// • Добавлен PUBG-like joystick в нижней части экрана
// • Движение ограничено землёй: XZ-plane, без полётов вверх/вниз
// • Inspector: X/Y позиция джойстика, скорость, высота камеры, радиус движения
// • Добавлены корректные lifecycle cleanup / dispose / unsubscribe
// ======================================================

import { defineModule } from "../../engine/moduleFactory.js";
import * as THREE from "../../libs/three.module.js";

import { createStageDOM } from "./entityStageDom.js";
...
export const registerTestShooterCameraModule = defineModule({
  ...
  inspector: {
    ...
    "Макс. дистанция от центра": {
      param: "maxMoveDistance",
      type: "range",
      min: 2,
      max: 80,
      step: 1,
