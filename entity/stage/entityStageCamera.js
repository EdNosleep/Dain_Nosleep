// ======================================================
// Dain_Coin — entityStageCamera.js v1
// Private camera helper for Entity Stage 3D
// ======================================================
//
// CHANGELOG v1:
// • Вынесены updateCamera / emitCameraChanged
// • Вынесены clampPitchParams / clampZoomParams
// • Вынесены getPixelRatio / normalizeSceneQuality
// • Camera-layer остаётся приватной частью entityStage3D
// ======================================================
