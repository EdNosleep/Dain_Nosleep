// ======================================================
// Dain_Coin — entityStage3D.js v19
// TrayPanel Lift + Camera Zoom-Out + Premium Inventory Drop
// ======================================================
...
// CHANGELOG v19:
// • Drop из Inventory теперь принимает primitiveId/id.
// • Добавлен handleAssetDrop как отдельная точка drop-placement.
// • При drop вне сцены эмитится ui:assetDropRejected.
// • При успешном drop эмитится ui:assetDropAccepted.
// • Tap-сценарий не изменён: Inventory создаёт фигуру по центру через entityEditor:addPrimitive.
// • Сохранены Lift/Zoom настройки v18.