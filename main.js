// ===============================
// Dain_Coin — MAIN ENTRY POINT (v17)
// Visual Engine + Concentric Pulse Test Helper
// ===============================
...
console.log("main.js v17: Visual Engine + Concentric Pulse Test Helper integrated");
...
async function enableModulesInBootOrder(enabledKeys) {
  ...
  for (let i = 0; i < orderedKeys.length; i++) {
    ...
    try {
      ...
      console.error(`main.js v17: failed to enable module ${key}`, error);
    }
...
// CHANGELOG v17:
// • Добавлен registerConcentricPulseTestButtonModule.
// • __concentricPulseTestButtonModule добавлен в DEFAULT_ENABLED_MODULES.
// • __concentricPulseTestButtonModule добавлен в MODULE_BOOT_ORDER после Visual Engine.
// • Visual Engine helper создаёт тестовую drag-кнопку.
// • Лог загрузки обновлён до main.js v17.
