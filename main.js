// ===============================
// Dain_Coin — MAIN ENTRY POINT (v10)
// Ordered Boot Queue + Loading Progress Bar
// ===============================
...
console.log("main.js v10: ordered boot queue + loading progress bar enabled");
...
async function enableModulesInBootOrder(enabledKeys) {
  ...
  for (let i = 0; i < orderedKeys.length; i++) {
    ...
    try {
      ...
      console.error(`main.js v10: failed to enable module ${key}`, error);
    }
...
// CHANGELOG v10:
// • Добавлена визуальная boot-полоска загрузки через #boot-progress
// • #boot теперь удаляется только после включения всех модулей
// • Добавлен прогресс по MODULE_BOOT_ORDER
// • Сохранён детерминированный порядок запуска модулей
// • Добавлен плавный fade-out после завершения boot
// • Исправлены preload-пути в index.html под текущую структуру assets
