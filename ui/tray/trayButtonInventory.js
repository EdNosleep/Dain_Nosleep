// ======================================
// NosleepEngine — TRAY BUTTON: INVENTORY (v12)
// Split Visual Helper + Vertical Drag Stable Ghost
// ======================================
...
// CHANGELOG v12:
// • Исправлено исчезновение ghost при резком вертикальном движении после long press.
// • После старта drag добавлен capture touchmove blocker с preventDefault.
// • lostpointercapture больше не отменяет активный drag.
// • touchAction временно переводится в none только после подтверждённого long press.
// • После finish/cancel кнопка возвращается в pan-y.
// • Scroll панели до long press сохранён.
// • Visual helper v1 не изменялся.