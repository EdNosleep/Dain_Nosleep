// ======================================
// NosleepEngine — TRAY BUTTON: INVENTORY (v14)
...
// CHANGELOG v14:
// • Убран DOM/SVG ghost для перетаскивания примитивов.
// • Inventory теперь только эмитит ui:assetDragStart / Move / End.
// • Реальное preview примитива передано во владение entityStage3D.
// • Tap-добавление примитива через entityEditor:addPrimitive сохранено.
// • Логика панели, Store-подписки и scroll restore сохранены.
// • Архитектурная граница Inventory как витрины ассетов восстановлена.