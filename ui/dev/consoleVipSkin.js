// ======================================
// Dain_Coin — CONSOLE VIP SKIN (v4)
// Premium Pressable Buttons
// ======================================
    ...
    applyButton(btn, variant = "ghost") {
      Object.assign(btn.style, {
        ...
        boxShadow: variant === "primary"
          ? `0 0 16px rgba(${accent},0.18), inset 0 1px 0 rgba(255,255,255,0.14), inset 0 -8px 14px rgba(0,0,0,0.10)`
          : "inset 0 1px 0 rgba(255,255,255,0.10), inset 0 -8px 14px rgba(0,0,0,0.12)"
      });

      btn.onpointerdown = () => {
        btn.style.transform = "translateY(1.5px) scale(0.965)";
        btn.style.boxShadow = variant === "primary"
          ? `0 0 8px rgba(${accent},0.12), inset 0 2px 6px rgba(0,0,0,0.26)`
...
// CHANGELOG consoleVipSkin.js v4:
// • Добавлена премиальная press-анимация для всех кнопок консоли.
// • Кнопки теперь визуально проседают при pointerdown.
// • Добавлены transition, scale, translateY и tactile inset-shadow.
// • Улучшен glass-gradient для ghost-кнопок.
// • Активные filter-кнопки сохранили glow, но получили объём.
// • Логика console.js не изменялась.